...
/**
 * The share card, generated by app/og.png/route.tsx.
 *
 * Stated explicitly here rather than relying on Next's `opengraph-image` file
 * convention — that convention emits an extensionless file which a static
 * host serves as application/octet-stream, and link crawlers won't render it.
 * See the comment in that route for the full reasoning.
 */
